...
$qt=$crud->displayAllWithOrderAndId2('department','name','desc',$_GET['id']);
?>
     ...
     foreach($qt as $dy){
         ...
         <div class="col-lg-3 col-6">
            ...
            <div class="small-box <?=$a[$c];?>">
              ...
              <a href="view-book.php?college=<?=$dy['college_id']?>&department=<?=$dy['id'];?>" class="small-box-footer">Click to access books <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
